...
const LAYER_EMPTY_REASONS: Record<string, string> = {
  ...
  "policy-program-watch":
    "This layer's agent tracks CMS policy announcements and program changes - a live data source hasn't been wired to it yet.",
  "emerging-signals":
    ...
    <>
      ...
      <section className="container" style={{ padding: "32px 24px 32px", borderTop: "1px solid var(--border)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 14 }}>
          ...
          <StatTile label="Real CMS datasets wired" value="3" />
          <StatTile
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "var(--text-muted)" }}>
              ...
              and CMS Medicare Physician &amp; Other Practitioners (submitted charges vs. actual Medicare payment by
              provider type and state — a 5-state sample, not the full national file). All three are public,
              no-registration CMS datasets — chosen because they&apos;re directly queryable and update on a
              predictable cadence, which matters for a project run on a fixed budget and a once-a-quarter refresh
              schedule rather than a live production feed. Two independent sources sharing the same states is also
              what makes the Emerging Signals cross-check below possible.
            </p>
          </div>
          <div>
