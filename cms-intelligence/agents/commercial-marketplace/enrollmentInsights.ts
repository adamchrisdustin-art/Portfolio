...
function nationalTrendInsight(years: OepYear[]): Insight | null {
  ...
  return validateInsight({
    ...
    businessRelevance: "Marketplace enrollment is the size of the individual-market opportunity for every exchange issuer (Q066); a national decline after years of growth changes membership forecasts and risk-pool assumptions.",
...
async function stateChangeInsight(years: OepYear[], ctx: AgentContext): Promise<Insight | null> {
  ...
  return validateInsight({
    ...
    businessRelevance: "Where exchange membership is growing or shrinking fastest - the states where issuers' individual-market volume, and the pool's average risk, are shifting most (Q066).",
