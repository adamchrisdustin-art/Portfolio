...
|---|---|---|---|---|---|---|---|
| anthropic:claude-haiku-4-5-20251001 | 0.80 | 100% | 0% | 100% | 42% | 2206 | $0.00222 |
| openai:gpt-4o-mini | 0.62 | 100% | 0% | 67% | 33% | 1721 | $0.00027 |

## Per-task detail

### anthropic:claude-haiku-4-5-20251001
- **cms-eval-001-utilization-trend** (utilization-trend) — score 0.70, 2791ms — Did not cite any expected source.
- **cms-eval-002-reimbursement-change** (reimbursement-change) — score 0.35, 1540ms — Missing expected facts: Diagnostic Radiology. Did not cite any expected source.
...
- **cms-eval-006-site-of-care-change** (site-of-care-change) — score 1.00, 2652ms
...
- **cms-eval-002-reimbursement-change** (reimbursement-change) — score 0.35, 2567ms — Missing expected facts: Diagnostic Radiology. Did not cite any expected source.
